...
cReferenceMeasChannel::cReferenceMeasChannel(const ChannelRangeObserver::ChannelPtr croChannel, NetworkConnectionInfo pcbsocket, VeinTcp::AbstractTcpNetworkFactoryPtr tcpNetworkFactory,
