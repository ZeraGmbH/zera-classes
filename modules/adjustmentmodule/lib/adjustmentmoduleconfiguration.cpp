...
void cAdjustmentModuleConfiguration::configXMLInfo(QString key)
{
    ...
    if (m_ConfigXMLMap.contains(key))
    {
        ...
        default:
            ...
            if ((cmd >= setChn1AmplInfoAvail) && (cmd < setChn1AmplInfoAvail + 32))
            {
                QString chn;
            ...
            if ((cmd >= setChn1AmplInfoEntity) && (cmd < setChn1AmplInfoEntity + 32))
            {
                QString chn;
                cAdjChannelInfo* adjChannelInfo;
            ...
            if ((cmd >= setChn1AmplInfoComponent) && (cmd < setChn1AmplInfoComponent + 32))
            {
                QString chn;
                cAdjChannelInfo* adjChannelInfo;
            ...
            if ((cmd >= setChn1PhaseInfoAvail) && (cmd < setChn1PhaseInfoAvail + 32))
            {
                QString chn;
                cAdjChannelInfo* adjChannelInfo;
            ...
            if ((cmd >= setChn1PhaseInfoEntity) && (cmd < setChn1PhaseInfoEntity + 32))
            {
                QString chn;
                cAdjChannelInfo* adjChannelInfo;
            ...
            if ((cmd >= setChn1PhaseInfoComponent) && (cmd < setChn1PhaseInfoComponent + 32))
            {
                QString chn;
                cAdjChannelInfo* adjChannelInfo;
            ...
            if ((cmd >= setChn1OffsInfoEntity) && (cmd < setChn1OffsInfoEntity + 32))
            {
                QString chn;
                cAdjChannelInfo* adjChannelInfo;
            ...
            if ((cmd >= setChn1OffsInfoComponent) && (cmd < setChn1OffsInfoComponent + 32))
            {
                QString chn;
                cAdjChannelInfo* adjChannelInfo;
