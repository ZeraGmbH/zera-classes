...
void cDftModuleMeasProgram::setDspVarList()
{
    ...
    tmpDataDsp->addDspVar("VALXDFT",2*m_veinActValueList.count(), DSPDATA::vDspTemp);
    tmpDataDsp->addDspVar("FILTER", DspBuffLen::avgFilterLen(2*m_veinActValueList.count()), DSPDATA::vDspTemp);
