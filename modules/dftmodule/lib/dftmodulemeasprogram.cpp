...
void cDftModuleMeasProgram::setDspVarList()
{
    ...
    tmpDspVarGroup->addDspVar("VALXDFT",2*m_veinActValueList.count(), DSPDATA::vDspTemp);
    tmpDspVarGroup->addDspVar("FILTER", DspBuffLen::avgFilterLen(2*m_veinActValueList.count()), DSPDATA::vDspTemp);
