...
void cStatusModuleInit::generateVeinInterface()
{
    ...
    m_pPCBServerVersion = new VfModuleParameter(m_pModule->getEntityId(), m_pModule->m_pModuleValidator,
                                                ...
                                                QVariant(QString("")) );
    m_pPCBServerVersion->setScpiInfo("STATUS", "VERSION:PCBSERVER", SCPI::isQuery, key , SCPI::isComponent);
    ...
    m_pPCBVersion = new VfModuleParameter(m_pModule->getEntityId(), m_pModule->m_pModuleValidator,
                                          ...
                                          QString("PCB version"),
                                          QVariant(QString("")) );
    m_pPCBVersion->setScpiInfo("STATUS", "VERSION:PCB", SCPI::isQuery, key , SCPI::isComponent);
    ...
    m_pCtrlVersion = new VfModuleParameter(m_pModule->getEntityId(), m_pModule->m_pModuleValidator,
                                              ...
                                              QVariant(QString("") ));
    m_pCtrlVersion->setScpiInfo("STATUS", "VERSION:CONTROLER", SCPI::isQuery, key, SCPI::isComponent);
    ...
    m_pFPGAVersion = new VfModuleParameter(m_pModule->getEntityId(), m_pModule->m_pModuleValidator,
                                           ...
                                           QVariant(QString("") ));
    m_pFPGAVersion->setScpiInfo("STATUS", "VERSION:FPGA", SCPI::isQuery, key, SCPI::isComponent);
    ...
    m_pSerialNumber->setScpiInfo("STATUS", "SERIAL", SCPI::isQuery|SCPI::isCmdwP, key, SCPI::isComponent);
    ...
    m_pDSPServerVersion = new VfModuleParameter(m_pModule->getEntityId(), m_pModule->m_pModuleValidator,
                                                ...
                                                QVariant(QString("") ));
    m_pDSPServerVersion->setScpiInfo("STATUS", "VERSION:DSPSERVER", SCPI::isQuery, key, SCPI::isComponent);
    ...
    m_pDSPProgramVersion = new VfModuleParameter(m_pModule->getEntityId(), m_pModule->m_pModuleValidator,
                                                 ...
                                                 QVariant(QString("") ));
    m_pDSPProgramVersion->setScpiInfo("STATUS", "VERSION:DSP", SCPI::isQuery, key, SCPI::isComponent);
    ...
    m_pReleaseNumber = new VfModuleParameter(m_pModule->getEntityId(), m_pModule->m_pModuleValidator,
                                             ...
                                             QVariant(QString("") ));
    m_pReleaseNumber->setScpiInfo("STATUS", "RELEASE", SCPI::isQuery, key, SCPI::isComponent);
    ...
    m_pDeviceType = new VfModuleParameter(m_pModule->getEntityId(), m_pModule->m_pModuleValidator,
                                                ...
                                                QString("Device type"),
                                                QVariant(QString()));
    m_pDeviceType->setScpiInfo("STATUS", "DEVTYPE", SCPI::isQuery, key, SCPI::isComponent);
    ...
    m_pCPUInfo = new VfModuleParameter(m_pModule->getEntityId(), m_pModule->m_pModuleValidator,
                                       ...
                                       QVariant(QString("")));
    m_pCPUInfo->setScpiInfo("STATUS", "CPUINFO", SCPI::isQuery, key, SCPI::isComponent);
    ...
    m_pAdjustmentStatus = new VfModuleParameter(m_pModule->getEntityId(), m_pModule->m_pModuleValidator,
                                                   ...
                                                   QVariant(""));
    m_pAdjustmentStatus->setScpiInfo("STATUS", "ADJUSTMENT", SCPI::isQuery, key, SCPI::isComponent);
    ...
    m_pAdjustmentChksum = new VfModuleParameter(m_pModule->getEntityId(), m_pModule->m_pModuleValidator,
                                                   ...
                                                   QVariant(""));
    m_pAdjustmentChksum->setScpiInfo("STATUS", "ADJCHKSUM", SCPI::isQuery, key, SCPI::isComponent);
    ...
    m_pSchnubbelStatus = new VfModuleParameter(m_pModule->getEntityId(), m_pModule->m_pModuleValidator,
                                               ...
                                               QVariant(0));
    m_pSchnubbelStatus->setScpiInfo("STATUS", "AUTHORIZATION", SCPI::isQuery, key, SCPI::isComponent);
    ...
    if (m_ConfigData.m_accumulator) {
        m_pAccumulatorSoc->setScpiInfo("STATUS", "ACCUSOC", SCPI::isQuery, key, SCPI::isComponent);
        m_pAccumulatorStatus->setScpiInfo("STATUS", "ACCUSTATUS", SCPI::isQuery, key, SCPI::isComponent);
    }
}
