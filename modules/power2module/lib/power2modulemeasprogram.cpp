    ...
    m_pModule(module)
{
    ...
    m_pcbserverConnectState4freqChannels.addTransition(this, &cPower2ModuleMeasProgram::activationContinue, &m_readSenseChannelInformationState);

    m_readSenseChannelInformationState.addTransition(this, &cPower2ModuleMeasProgram::activationContinue, &m_readSenseDspChannelState);
    ...
    m_readSenseChannelInformationDoneState.addTransition(this, &cPower2ModuleMeasProgram::activationLoop, &m_readSenseDspChannelState);
...
void cPower2ModuleMeasProgram::foutParamsToDsp()
{
    ...
    if (isValidConstant && getConfData()->m_nFreqOutputCount > 0) { // dsp-interface will crash for missing parts...
        ...
        datalist += ";";
        DspInterfaceCmdDecoder::setVarData(m_pfreqScaleDSP, datalist);
    ...
    DspInterfaceCmdDecoder::setVarData(m_pNomPower, datalist);
...
void cPower2ModuleMeasProgram::dspSetParamsTiMModePhase(int tiTimeOrPeriods)
{
    ...
    DspInterfaceCmdDecoder::setVarData(m_pParameterDSP, strVarData, DSPDATA::dInt);
