...
DemoValuesDspDspSuper::DemoValuesDspDspSuper(QStringList channelMNameList,
...
void DemoValuesDspDspSuper::setValue(QString channelMName, int period, double value)
{
    if(m_values.contains(channelMName))
        m_values[channelMName][period] = value;
}

QVector<float> DemoValuesDspDspSuper::getDspValues()
{
