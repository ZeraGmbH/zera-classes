...
void test_scpi_learn_measure_objects_and_relations::queryMeasure()
{
    ...
    QCOMPARE(SCPIMODULE::ScpiMeasurePerVeinComponentSequencer::getInstanceCount(), measureComponentCount);
    ...
    QCOMPARE(SCPIMODULE::ScpiMeasurePerVeinComponentSequencer::getInstanceCount(), 2 * measureComponentCount); // module + client
