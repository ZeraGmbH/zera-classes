...
void cAdjustManagement::generateVeinInterface()
{
    ...
    m_ParIgnoreRmsValuesOnOff->setScpiInfo("CONFIGURATION","ENABLEIGNORERMSVAL", SCPI::isQuery|SCPI::isCmdwP, m_ParIgnoreRmsValuesOnOff->getName(), SCPI::isComponent);
    ...
    m_ParIgnoreRmsValues->setScpiInfo("CONFIGURATION","IGNORERMSVAL", SCPI::isQuery|SCPI::isCmdwP, m_ParIgnoreRmsValues->getName(), SCPI::isComponent);
...
void cAdjustManagement::activationDone()
{
    ...
    for(int i = 0; i < m_ChannelList.count(); i++) {
        ...
        m_invertedPhasesParList.at(i)->setScpiInfo("CONFIGURATION",QString("%1:INVERTPHASE").arg(m_ChannelList.at(i)->getAlias()), SCPI::isQuery|SCPI::isCmdwP, m_invertedPhasesParList.at(i)->getName(), SCPI::isComponent);
    }
    m_bActive = true;
    emit activated();
}
