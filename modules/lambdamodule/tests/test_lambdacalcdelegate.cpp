...
void test_lambdacalcdelegate::measModeAvail3LW()
{
    ...
    delegate.handleActivePowerSet(0, 1.0);
    delegate.handleActivePowerSet(1, 0.0);
    delegate.handleActivePowerSet(2, 1.0);
    delegate.handleActivePowerSet(3, 2.0);
    delegate.handleApparentPowerSet(0, 1.0);
    delegate.handleApparentPowerSet(1, 2.0);
    delegate.handleApparentPowerSet(2, 1.0);
    delegate.handleApparentPowerSet(3, 8.0);
...
void test_lambdacalcdelegate::measModeAvailPhaseMask110()
{
    ...
    delegate.handleActivePowerSet(0, 1.0);
    delegate.handleActivePowerSet(1, 1.0);
    delegate.handleActivePowerSet(2, 0.0);
    delegate.handleActivePowerSet(3, 2.0);
    delegate.handleApparentPowerSet(0, 2.0);
    delegate.handleApparentPowerSet(1, 2.0);
    delegate.handleApparentPowerSet(2, 4.0);
    delegate.handleApparentPowerSet(3, 8.0);
...
void test_lambdacalcdelegate::measModeNotAvailPhaseMask110()
{
    ...
    delegate.handleApparentPowerSet(1, 2.0);
    delegate.handleApparentPowerSet(2, 4.0);
    delegate.handleApparentPowerSet(3, 10.0);
    delegate.onActivePowerPhaseMaskChange("110");
