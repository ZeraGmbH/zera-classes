...
ZeraModules::VirtualModule* BleModuleFactory::createModule(int entityId, VeinEvent::StorageSystem* storagesystem, bool demo)
{
    ZeraModules::VirtualModule *module = new cBleModule(m_ModuleList.count()+1, entityId, storagesystem, demo);
