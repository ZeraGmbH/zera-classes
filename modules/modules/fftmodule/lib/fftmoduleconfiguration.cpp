...
void cFftModuleConfiguration::setConfiguration(QByteArray xmlString)
{
    ...
    m_ConfigXMLMap["fftmodconfpar:configuration:connectivity:debuglevel"] = setDebugLevel;
...
void cFftModuleConfiguration::configXMLInfo(QString key)
{
    ...
    if (m_ConfigXMLMap.contains(key))
    {
        ...
        {
        case setDebugLevel:
            m_pFftModulConfigData->m_nDebugLevel = m_pXMLReader->getValue(key).toInt(&ok);
            break;
        case setRMIp:
