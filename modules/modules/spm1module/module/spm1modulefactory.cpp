...
ZeraModules::VirtualModule* Spm1ModuleFactory::createModule(int entityId, VeinEvent::StorageSystem *storagesystem, bool demo, QObject *parent)
{
    ZeraModules::VirtualModule *module = new cSpm1Module(m_ModuleList.count()+1, entityId, storagesystem, demo, parent);
