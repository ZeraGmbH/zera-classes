...
ElectronicBurdenModuleConfiguration::ElectronicBurdenModuleConfiguration()
{
}


void ElectronicBurdenModuleConfiguration::setConfiguration(QByteArray xmlString)
{
    ...
    QString xsdLocation = QStringLiteral("file://") + configPath + QStringLiteral("electronicburdenmodule-config.xsd");
...
QByteArray ElectronicBurdenModuleConfiguration::exportConfiguration()
{
...
configuration* ElectronicBurdenModuleConfiguration::getConfigXMLWrapper()
{
