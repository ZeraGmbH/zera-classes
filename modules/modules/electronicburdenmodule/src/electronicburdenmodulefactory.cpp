...
ZeraModules::VirtualModule* ElectronicBurdenModuleFactory::createModule(int entityId, VeinEvent::StorageSystem* storagesystem, bool demo, QObject* parent)
{
    ZeraModules::VirtualModule *module = new ElectronicBurdenModule(m_ModuleList.count()+1, entityId, storagesystem, demo, parent);
