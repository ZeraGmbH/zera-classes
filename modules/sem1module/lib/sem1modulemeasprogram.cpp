...
void cSem1ModuleMeasProgram::generateVeinInterface()
{
    ...
    m_pRefConstantPar = new VfModuleParameter(m_pModule->getEntityId(), m_pModule->m_pModuleValidator,
                                                 ...
                                                 QVariant((double)0.0));
    m_pRefConstantPar->setScpiInfo("CALCULATE", QString("%1:REFCONSTANT").arg(modNr ), SCPI::isQuery, m_pRefConstantPar->getName(), SCPI::isComponent);
    ...
    m_pTargetedPar = new VfModuleParameter(m_pModule->getEntityId(), m_pModule->m_pModuleValidator,
                                              ...
                                              QString("Stop mode"),
                                              QVariant((int)0));
    m_pTargetedPar->setScpiInfo("CALCULATE", QString("%1:MODE").arg(modNr), SCPI::isQuery|SCPI::isCmdwP, m_pTargetedPar->getName(), SCPI::isComponent);
    ...
    m_pMeasTimePar = new VfModuleParameter(m_pModule->getEntityId(), m_pModule->m_pModuleValidator,
                                              ...
                                              QVariant((uint)10));
    m_pMeasTimePar->setScpiInfo("CALCULATE", QString("%1:MTIME").arg(modNr), SCPI::isQuery|SCPI::isCmdwP, m_pMeasTimePar->getName(), SCPI::isComponent);
    ...
    m_pT0InputPar = new VfModuleParameter(m_pModule->getEntityId(), m_pModule->m_pModuleValidator,
                                             ...
                                             QVariant((double)0.0));
    m_pT0InputPar->setScpiInfo("CALCULATE", QString("%1:T0INPUT").arg(modNr), SCPI::isQuery|SCPI::isCmdwP, m_pT0InputPar->getName(), SCPI::isComponent);
    ...
    m_pT1InputPar = new VfModuleParameter(m_pModule->getEntityId(), m_pModule->m_pModuleValidator,
                                             ...
                                             QVariant((double)0.0));
    m_pT1InputPar->setScpiInfo("CALCULATE", QString("%1:T1INPUT").arg(modNr), SCPI::isQuery|SCPI::isCmdwP, m_pT1InputPar->getName(), SCPI::isComponent);
    ...
    m_pInputUnitPar = new VfModuleParameter(m_pModule->getEntityId(), m_pModule->m_pModuleValidator,
                                               ...
                                               QString("Energy unit"),
                                               QVariant("Unknown"));
    m_pInputUnitPar->setScpiInfo("CALCULATE", QString("%1:TXUNIT").arg(modNr), SCPI::isQuery|SCPI::isCmdwP, m_pInputUnitPar->getName(), SCPI::isComponent);
    ...
    m_pStartStopPar = new VfModuleParameter(m_pModule->getEntityId(), m_pModule->m_pModuleValidator,
                                               ...
                                               QVariant((int)0));
    m_pStartStopPar->setScpiInfo("CALCULATE", QString("%1:START").arg(modNr), SCPI::isQuery|SCPI::isCmdwP, "PAR_StartStop", SCPI::isComponent);
    ...
    m_pTimeAct = new VfModuleParameter(m_pModule->getEntityId(), m_pModule->m_pModuleValidator,
                                          ...
                                          QString("Measurement time"),
                                          QVariant((double) 0.0));
    m_pTimeAct->setScpiInfo("CALCULATE", QString("%1:TIME").arg(modNr), SCPI::isQuery, m_pTimeAct->getName(), SCPI::isComponent);
    ...
    m_pPowerAct = new VfModuleParameter(m_pModule->getEntityId(), m_pModule->m_pModuleValidator,
                                           ...
                                           QVariant((double) 0.0));
    m_pPowerAct->setScpiInfo("CALCULATE", QString("%1:POWER").arg(modNr), SCPI::isQuery, m_pPowerAct->getName(), SCPI::isComponent);
