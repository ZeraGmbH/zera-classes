    ...
    m_valueType(valueType)
{
    switch(valueType) {
    case RandomValues:
        m_valueGenerator = DemoRandomGenerators::generatorRandom;
        break;
    case FixedValues:
        m_valueGenerator = DemoRandomGenerators::generatorFixed;
        break;
    case ReproducableChangeValues:
        m_valueGenerator = DemoRandomGenerators::generatorReproducibleChange;
        break;
    }
}
...
{
    return std::make_shared<DemoDspInterfacePeriodAverage>(entityId,
                                                           valueChannelList, maxPeriodCount, initialPeriodCount,
                                                           m_valueGenerator);
}
...
Zera::DspInterfacePtr DemoFactoryServiceInterfaces::createDspInterfaceStatus(int entityId)
{
    Q_UNUSED(entityId)
    return std::make_shared<Zera::cDSPInterface>();
}
