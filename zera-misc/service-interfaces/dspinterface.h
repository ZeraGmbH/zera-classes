...
public:
    ...
    quint32 bootDsp();
    quint32 resetDsp();
    quint32 setDSPBootPath(QString path);
    ...
    quint32 setDsp61850SourceAdr(cETHAdress& ethadr); // set eth source adr
    quint32 setDsp61850DestAdr(cETHAdress& ethadr); // set eth dest adr
    ...
    quint32 readServerVersion(); // what do you think ?
